  ...
  let html = `
    ...
    <div class="card-box" style="margin-bottom:16px">
      ...
      <table style="width:100%;font-size:13px">
        <tr><td style="color:#6b7280;padding:6px 12px;width:140px">Version</td><td style="font-weight:600">${GAS_CONFIG?.version || 'N/A'} (GAS) / ${window.COMPHONE_VERSION || 'v5.18.16-runtime-selftest'} (PWA)</td></tr>
