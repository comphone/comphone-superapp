...
function loadSection(sectionName) {
  ...
  const renderers = {
    ...
    'billing':     () => { if (main) main.innerHTML = '<div class="card-box"><h3><i class="bi bi-receipt"></i> ใบเสร็จ/วางบิล</h3><p style="color:#9ca3af">⏳ กำลังพัฒนา...</p></div>'; },
    'warranty':    () => { if (main) main.innerHTML = '<div class="card-box"><h3><i class="bi bi-shield-check"></i> รับประกัน</h3><p style="color:#9ca3af">⏳ กำลังพัฒนา...</p></div>'; },
    ...
    'reports':     () => { if (main) main.innerHTML = '<div class="card-box"><h3><i class="bi bi-file-earmark-text"></i> รายงาน</h3><p style="color:#9ca3af">⏳ กำลังพัฒนา...</p></div>'; },
    'analytics':   () => { if (main) main.innerHTML = '<div class="card-box"><h3><i class="bi bi-graph-up"></i> Analytics</h3><p style="color:#9ca3af">⏳ กำลังพัฒนา...</p></div>'; },
    ...
    'attendance':  () => { if (main) main.innerHTML = '<div class="card-box"><h3><i class="bi bi-clock-history"></i> ลงเวลาทำงาน</h3><p style="color:#9ca3af">⏳ กำลังพัฒนา...</p></div>'; },
