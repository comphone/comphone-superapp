// ============================================================
// COMPHONE SUPER APP v5.9.0-phase31a — RouterSplit.gs
...
var MODULE_ROUTER = {
  ...
  'listJobArchive': function(p) { return listJobArchive(p); },
  'previewJobRestore': function(p) { return previewJobRestore(p); },
  'restoreJob': function(p) { return restoreJob(p); },
  ...
  'setupTelegramWebhook': function(p) { return setupTelegramWebhook(p); },
  'deleteTelegramWebhook': function(p) { return deleteTelegramWebhook(p); },
  'getTelegramBotInfo': function(p) { return getTelegramBotInfo(); },
  'testTelegramMessage': function(p) { return testTelegramMessage(p); },
  'sendTelegramMessage': function(p) { return sendTelegramMessage(p.message || p.text || '', p.chat_id || p.chatId || p.telegram_chat_id || ''); },
  ...
  // Agent Platform
  'acknowledgeAlert': function(p) { return acknowledgeLineAlert(p); },
  'acknowledgeLineAlert': function(p) { return acknowledgeLineAlert(p); },
  ...
  'bulkAcknowledge': function(p) { return bulkAcknowledgeLineAlerts(p); },
  'bulkAcknowledgeLineAlerts': function(p) { return bulkAcknowledgeLineAlerts(p); },
  ...
  'getAlertAnalytics': function(p) { return getAlertAnalytics((p && p.days) || p || 7); },
  ...
  'linkVisionToJobTimeline': function(p) { return linkVisionToJobTimeline(p); },
  ...
  'queueLineCommandAlert': function(p) { return queueLineCommandAlert(p); },
  ...
  'previewLineRoomMessage': function(p) { return previewLineRoomMessage(p); },
  'sendLineRoomMessage': function(p) { return sendLineRoomMessage(p); },
