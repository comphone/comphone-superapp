...
### 6.6 ระบบรายงาน LINE Group แบบโต้ตอบ (Interactive LINE Reports)
> **เป้าหมาย:** ให้รายงานในกลุ่ม LINE ไม่ใช่แค่ข้อความแจ้งเตือน แต่เป็น "ศูนย์กลางการทำงาน" ที่กดลิงก์เข้าไปจัดการต่อได้ทันที

เมื่อมีการเปิดงานใหม่ หรืออัปเดตสถานะ ระบบจะส่งรายงานเข้ากลุ่ม LINE ในรูปแบบ **Flex Message หรือ Text ที่มีโครงสร้างชัดเจน**:
- **รายละเอียดงาน:** Job ID, ชื่อลูกค้า, อาการเสีย, สถานะปัจจุบัน
- **ลิงก์จัดการงาน (Deep Link):** ลิงก์ตรงไปยังหน้า Job Detail Modal ของงานนั้นๆ (เช่น `https://.../?view=jobqr&jobId=JOB123`)
- **ปุ่มแนบรูปภายหลัง:** ช่างสามารถกดลิงก์เพื่อเปิดหน้า Web App สำหรับอัปโหลดรูปภาพเพิ่มเติมเข้างานนั้นๆ ได้ตลอดเวลา โดยไม่ต้องส่งรูปเข้ากลุ่ม LINE ให้รก
- **ลิงก์ดูรูปภาพ (Photo Gallery):** ลิงก์สำหรับดูรูปภาพทั้งหมดของงานนั้นๆ (Before/After/อะไหล่)
