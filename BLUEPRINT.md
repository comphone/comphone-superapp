...
- **Current phase:** Sprint / Phase 175.
...
- **Next recommended sprint:** Sprint 176 should run a fresh-token protected live acceptance session on the already published `v5.18.40-sprint175` Pages build; Sprint 177 should execute a real AI Vision sample only if the owner supplies a sample image and sets all Sprint 175 gates. Do not run real LINE sends or `executeDataRepair` from CI.
