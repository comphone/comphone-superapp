...
- **PWA version:** `v5.18.44-sprint183`.
...
|---|---|---|
| App Version | `v5.18.44-sprint183` | `pwa/version_config.js` |
| Cache Version | `comphone-v5.18.44-sprint183-20260521_0930` | `pwa/version_config.js`, `pwa/sw.js` |
...
- PWA cache was bumped to `v5.18.44-sprint183` / `20260521_0930`.
