...
### 9.2 Service Worker
| **Version:** `CACHE_VERSION = 'comphone-v5.18.34-job-menu-hardening-20260516_0815'`
...
| Surface | File | Key |
|---------|------|-----|
| SW Cache | `sw.js` | `CACHE_VERSION = 'comphone-v5.18.34-job-menu-hardening-20260516_0815'` |
| PWA Version | `version_config.js` | `APP_VERSION = 'v5.18.34-job-menu-hardening'` |
| Build Timestamp | `version_config.js` | `BUILD_TIMESTAMP = '20260516_0815'` |
...
| งาน | สถานะ | อุปสรรค |
|------|-------|----------|
| **Login / Splash / Menu Recovery** | OK **resolved in current baseline** | `api_client.js`, auth guard, service worker activation, menu restore, and API contract smoke are stable at GAS @612 / cache `comphone-v5.18.34-job-menu-hardening-20260516_0815`. |
