...
- **Current phase:** Sprint / Phase 179.
...
- **PWA version:** `v5.18.42-sprint179`.
...
- **Next recommended sprint:** Sprint 180 should run the strict protected-live proof with a fresh hidden token and `COMPHONE_SPRINT178_STRICT_LIVE=1`; Sprint 181 should execute real AI Vision only after owner supplies a sample image and sets all Sprint 179 gates. Do not run real LINE sends or `executeDataRepair` from CI.
...
|---|---|---|
| App Version | `v5.18.42-sprint179` | `pwa/version_config.js` |
| Cache Version | `comphone-v5.18.42-sprint179-20260521_0700` | `pwa/version_config.js`, `pwa/sw.js` |
| Build Timestamp | `20260521_0700` | `pwa/version_config.js` |
