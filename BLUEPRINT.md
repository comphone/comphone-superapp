...
> **Date:** 2026-05-18 | **Phase:** 129 (AI Vision LINE Suppression Live QA)
...
- **Current phase:** Sprint / Phase 129.
...
- **Production GAS deployment:** `AKfycbwN_mbyHOJ4vXRNpHjuN8dUFbXjERwtgTbNROt5_ynakfYm6Xv4RrgvhPMvI53lIhPWBA @614`.
...
- **Next recommended sprint:** Deploy build `20260518_0730`, rerun `pages_deploy_verify.js`, then run `node scripts/sprint124_protected_visual_menu_qa.js` again with a fresh session token to capture protected live evidence.
- **After Sprint 129:** run `node scripts/sprint129_vision_line_suppression_live_qa.js` with a fresh token and `COMPHONE_VISION_LINE_SUPPRESSION_CONFIRM=RUN_MUTED_VISION_NOTIFICATION` to capture muted Vision LINE suppression evidence, then proceed to a carefully gated real-send test only after owner approval.
