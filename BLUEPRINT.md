...
- **Current phase:** Sprint / Phase 177.
...
- **PWA version:** `v5.18.41-sprint177`.
...
- **Next recommended sprint:** Sprint 178 should run strict protected acceptance with a fresh hidden token and `COMPHONE_SPRINT176_REQUIRE_LIVE=1`; Sprint 179 should run the real AI Vision sample only after the owner supplies a sample image and sets `COMPHONE_SPRINT177_EXECUTE_REAL_SAMPLE=1` plus all Sprint 175 gates. Do not run real LINE sends or `executeDataRepair` from CI.
...
|---|---|---|
| App Version | `v5.18.41-sprint177` | `pwa/version_config.js` |
| Cache Version | `comphone-v5.18.41-sprint177-20260521_0600` | `pwa/version_config.js`, `pwa/sw.js` |
| Build Timestamp | `20260521_0600` | `pwa/version_config.js` |
