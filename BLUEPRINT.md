...
- Post-deploy expected result: `getDashboardData` should return Dashboard Bundle data with `_compat=getDashboardData` and lower repeated-call latency from CacheService. Rerun Sprint 87 protected live QA after GAS deploy completes to confirm the dashboard slow warning is gone.
