...
- **Current phase:** Sprint / Phase 163.
...
- **PWA version:** `v5.18.37-sprint163`.
...
- **Next recommended sprint:** Sprint 164 should rerun Pages publish confirmation after GitHub Pages publishes `v5.18.37-sprint163`, then Sprint 165 should perform a real browser/profile click-through with a fresh session token. Do not run real LINE sends or `executeDataRepair` from CI.
...
|---|---|---|
| App Version | `v5.18.37-sprint163` | `pwa/version_config.js` |
| Cache Version | `comphone-v5.18.37-sprint163-20260521_0200` | `pwa/version_config.js`, `pwa/sw.js` |
| Build Timestamp | `20260521_0200` | `pwa/version_config.js` |
...
- PWA cache was bumped to `v5.18.37-sprint163` / `20260521_0200`; PC and Mobile asset query strings now point at the same build.
