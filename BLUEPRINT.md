...
> **Version:** v5.18.17-writeflow-stability (PWA) / GAS Backend v5.18.8-auth-session-store @545
...
- Service worker cache bumped to `comphone-v5.18.17-writeflow-stability-20260507_1130` to force browsers off the previous integrity-audit bundle.
