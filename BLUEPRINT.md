...
> **Date:** 2026-05-18 | **Phase:** 123 (Live Visual QA Guard)
...
- **Current phase:** Sprint / Phase 123.
...
- **Next recommended sprint:** Deploy build `20260518_0535`, rerun `pages_deploy_verify.js`, then do protected live visual/menu QA with a fresh session token for mobile More-menu pages and PC dashboard sections.
- **After Sprint 123:** continue with role-based dashboard widgets and richer visual screenshots only after Pages confirms the new build is fresh.
...
| Cache Version | `comphone-v5.18.34-job-menu-hardening-20260518_0535` | `pwa/version_config.js`, `pwa/sw.js` |
| Build Timestamp | `20260518_0535` | `pwa/version_config.js` |
...
- Bumped PWA cache/build timestamp to `20260518_0535` so mobile/PC clients pick up the live visual QA guard pass.
...
- Bumped PWA cache/build timestamp to `20260518_0535` so mobile/PC clients pick up the dashboard operator analytics polish.
...
- Bumped PWA cache/build timestamp to `20260518_0535` so mobile/PC clients pick up the performance/accessibility pass.
...
- Bumped PWA cache/build timestamp to `20260518_0535` so mobile/PC clients pick up the Settings/Admin runtime hardening.
...
- Bumped PWA cache/build timestamp to `20260518_0535` so mobile/PC clients pick up the Inventory/PO/Warranty hardening.
