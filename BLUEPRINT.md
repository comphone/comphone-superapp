...
- **Current phase:** Sprint / Phase 158.
...
- **PWA version:** `v5.18.36-sprint158`.
...
- **Next recommended sprint:** Sprint 159 should rerun post-deploy Pages confirmation after GitHub Pages publishes `v5.18.36-sprint158`, then Sprint 160 should run protected token-backed Mobile/PC click-through with a real browser profile. Do not run real LINE sends or `executeDataRepair` from CI.
...
|---|---|---|
| App Version | `v5.18.36-sprint158` | `pwa/version_config.js` |
| Cache Version | `comphone-v5.18.36-sprint158-20260521_0100` | `pwa/version_config.js`, `pwa/sw.js` |
| Build Timestamp | `20260521_0100` | `pwa/version_config.js` |
