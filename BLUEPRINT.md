...
- **Current phase:** Sprint / Phase 181.
...
- **PWA version:** `v5.18.43-sprint181`.
...
- **Next recommended sprint:** Sprint 182 should run the protected-live proof with a fresh hidden token and `COMPHONE_SPRINT180_RUN_STRICT_PROOF=1`; Sprint 183 should run the owner-approved AI Vision sample only when the owner supplies the sample image and sets all Sprint 181 gates. Do not run real LINE sends or `executeDataRepair` from CI.
...
|---|---|---|
| App Version | `v5.18.43-sprint181` | `pwa/version_config.js` |
| Cache Version | `comphone-v5.18.43-sprint181-20260521_0800` | `pwa/version_config.js`, `pwa/sw.js` |
