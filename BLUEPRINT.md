...
> **Date:** 2026-05-18 | **Phase:** 128 (LINE Notification Toggle Live QA)
...
- **Current phase:** Sprint / Phase 128.
...
- **After Sprint 128:** run `node scripts/sprint128_line_notification_toggle_live_qa.js` with a fresh token and `COMPHONE_LINE_TOGGLE_CONFIRM=RUN_NOTIFICATION_TOGGLE_ROLLBACK` to capture rollback evidence, then test AI Vision LINE suppression with a real review item before enabling any real LINE send gate.
