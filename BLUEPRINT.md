...
- Current source of truth remains GitHub `main`, PWA v5.18.34, and GAS production deployment `@612`.
...
| GAS Deploy | `gas_config.js` / `Config.gs` | Production deploy URL @612 |
...
| งาน | สถานะ | อุปสรรค |
|------|-------|----------|
| **Login / Splash / Menu Recovery** | OK **resolved in current baseline** | `api_client.js`, auth guard, service worker activation, menu restore, and API contract smoke are stable at GAS @612 / cache `comphone-v5.18.34-job-menu-hardening-20260516_0845`. |
