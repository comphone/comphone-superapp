...
> **Version:** v5.18.47-sprint194 (PWA) / GAS Backend v5.18.16-write-flow-validation @620
...
- **PWA version:** `v5.18.47-sprint194`.
...
- PWA cache was bumped to `v5.18.47-sprint194` / `20260521_1200`.
