...
- **Current phase:** Sprint / Phase 183.
...
- **PWA version:** `v5.18.45-sprint183`.
- **GAS backend version:** `v5.18.16-write-flow-validation`.
- **Production GAS deployment:** `AKfycbyrhcek5kfmG26fJfi3RAbKAKlZWXvWwEow9AdLNb4QAsqOf_tqEQEFs_a5avUokOVk @619`.
- **Production GAS URL:** `https://script.google.com/macros/s/AKfycbyrhcek5kfmG26fJfi3RAbKAKlZWXvWwEow9AdLNb4QAsqOf_tqEQEFs_a5avUokOVk/exec`.
...
- **Next recommended sprint:** Sprint 184 should deploy GAS with `getVisionLineIngressStatus`, then run Sprint 182 cleanup execution with a fresh hidden owner/admin token only if the preview shows smoke-marker rows. Sprint 185 should run a real LINE group image pilot by sending a JobID-tagged image to a configured room, then process the queue and verify Vision evidence in Sheet/Drive. Do not run real LINE sends or `executeDataRepair` from CI.
...
|---|---|---|
| App Version | `v5.18.45-sprint183` | `pwa/version_config.js` |
| Cache Version | `comphone-v5.18.45-sprint183-20260521_1030` | `pwa/version_config.js`, `pwa/sw.js` |
| Build Timestamp | `20260521_0800` | `pwa/version_config.js` |
| GAS Backend Deploy | `AKfycbyrhcek5kfmG26fJfi3RAbKAKlZWXvWwEow9AdLNb4QAsqOf_tqEQEFs_a5avUokOVk @619` / production URL in `pwa/gas_config.js` | `Config.gs`, `Dashboard.gs`, `DashboardBundle.gs`, `Router.gs`, `RouterSplit.gs`, `JobStateMachine.gs`, `LineCommandCenter.gs`, `SmokeCleanup.gs`, `DataRepairConsole.gs`, `VisionPipeline.gs`, `PhotoQueue.gs`, `clasp-ready/Config.gs`, `clasp-ready/Dashboard.gs`, `clasp-ready/DashboardBundle.gs`, `clasp-ready/Router.gs`, `clasp-ready/RouterSplit.gs`, `clasp-ready/JobStateMachine.gs`, `clasp-ready/LineCommandCenter.gs`, `clasp-ready/SmokeCleanup.gs`, `clasp-ready/DataRepairConsole.gs`, `clasp-ready/VisionPipeline.gs`, `clasp-ready/PhotoQueue.gs` |
| GAS Production URL | `https://script.google.com/macros/s/AKfycbyrhcek5kfmG26fJfi3RAbKAKlZWXvWwEow9AdLNb4QAsqOf_tqEQEFs_a5avUokOVk/exec` | `pwa/gas_config.js` |
...
| รายการ | URL | สถานะ |
|--------|-----|-------|
| **GAS Web App (Production)** | `https://script.google.com/macros/s/AKfycbyrhcek5kfmG26fJfi3RAbKAKlZWXvWwEow9AdLNb4QAsqOf_tqEQEFs_a5avUokOVk/exec` | Active @619 |
