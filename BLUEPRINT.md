...
- **Current phase:** Sprint / Phase 168.
...
- **PWA version:** `v5.18.38-sprint168`.
...
- **Next recommended sprint:** Sprint 169 should rerun Pages publish lock after GitHub Pages publishes `v5.18.38-sprint168`, then Sprint 170 should run protected browser/profile click-through with a fresh session token. Do not run real LINE sends or `executeDataRepair` from CI.
...
|---|---|---|
| App Version | `v5.18.38-sprint168` | `pwa/version_config.js` |
| Cache Version | `comphone-v5.18.38-sprint168-20260521_0300` | `pwa/version_config.js`, `pwa/sw.js` |
| Build Timestamp | `20260521_0300` | `pwa/version_config.js` |
