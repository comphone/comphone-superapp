...
> **วันที่:** 24 เมษายน 2569 | **Phase:** 28.1
...
### 9.2 Service Worker
- **Version:** `CACHE_V = 'comphone-v5.6.8'`
...
| Surface | File | Key |
|---------|------|-----|
| SW Cache | `sw.js` | `CACHE_V = 'comphone-v5.6.8'` |
| PC Dashboard | `dashboard_pc.html` | `__APP_VERSION = 'v5.6.8'` |
