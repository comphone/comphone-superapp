...
- **Current phase:** Sprint / Phase 184.
...
- **PWA version:** `v5.18.46-sprint184`.
...
- **Next recommended sprint:** Sprint 185 should run a real LINE group image pilot by sending a JobID-tagged image to a configured room, then process the queue and verify Vision evidence in Sheet/Drive. Sprint 186 should add a restore flow for `DBJOBS_ARCHIVE` so archived jobs can be recovered by owner/admin when needed. Do not run real LINE sends, destructive job deletes, or `executeDataRepair` from CI.
...
|---|---|---|
| App Version | `v5.18.46-sprint184` | `pwa/version_config.js` |
| Cache Version | `comphone-v5.18.46-sprint184-20260521_1130` | `pwa/version_config.js`, `pwa/sw.js` |
...
- PWA cache was bumped to `v5.18.46-sprint184` / `20260521_1130`.
