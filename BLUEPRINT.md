...
> **Date:** 2026-05-18 | **Phase:** 127 (Vision + LINE Notification Controls)
...
- **Current phase:** Sprint / Phase 127.
...
- **After Sprint 127:** deploy the GAS source containing `getLineNotificationSettings` / `updateLineNotificationSettings`, then run protected LINE room smoke with a fresh token and verify one muted-room preview before enabling any real send gate.
