...
> **Date:** 2026-05-18 | **Phase:** 121 (Performance/Accessibility Pass)
...
- **Current phase:** Sprint / Phase 121.
...
- **Next recommended sprint:** Deploy build `20260518_0455`, rerun `pages_deploy_verify.js`, then run live PC/mobile visual smoke for menu transitions, focus rings, and loading fallback behavior.
- **After Sprint 121:** continue with dashboard visual polish and then advanced operator analytics.
...
| Cache Version | `comphone-v5.18.34-job-menu-hardening-20260518_0455` | `pwa/version_config.js`, `pwa/sw.js` |
| Build Timestamp | `20260518_0455` | `pwa/version_config.js` |
...
- Bumped PWA cache/build timestamp to `20260518_0455` so mobile/PC clients pick up the performance/accessibility pass.
...
- Bumped PWA cache/build timestamp to `20260518_0455` so mobile/PC clients pick up the Settings/Admin runtime hardening.
...
- Bumped PWA cache/build timestamp to `20260518_0455` so mobile/PC clients pick up the Inventory/PO/Warranty hardening.
