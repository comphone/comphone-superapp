...
> **Date:** 2026-05-18 | **Phase:** 120 (Settings/Admin Runtime Hardening)
...
- **Current phase:** Sprint / Phase 120.
...
- **Next recommended sprint:** Deploy build `20260518_0435`, rerun `pages_deploy_verify.js`, then run live PC Settings and Mobile Admin click-through with a fresh admin token.
- **After Sprint 120:** continue with performance/accessibility pass, then dashboard visual polish.
...
| Cache Version | `comphone-v5.18.34-job-menu-hardening-20260518_0435` | `pwa/version_config.js`, `pwa/sw.js` |
| Build Timestamp | `20260518_0435` | `pwa/version_config.js` |
...
- Bumped PWA cache/build timestamp to `20260518_0435` so mobile/PC clients pick up the Settings/Admin runtime hardening.
...
- Bumped PWA cache/build timestamp to `20260518_0435` so mobile/PC clients pick up the Inventory/PO/Warranty hardening.
