...
> **เวอร์ชัน:** v5.7.0 (PWA) / v5.6.5 (GAS Backend @491)
...
### 9.2 Service Worker
- **Version:** `CACHE_V = 'comphone-v5.7.0'`
...
| Surface | File | Key |
|---------|------|-----|
| SW Cache | `sw.js` | `CACHE_V = 'comphone-v5.7.0'` |
| PC Dashboard | `dashboard_pc.html` | `__APP_VERSION = 'v5.7.0'` |
...
> อัปเดตล่าสุด: 2026-04-24 | Phase 2E/28.1 | Commit `5026748` — Blueprint Reconciliation
