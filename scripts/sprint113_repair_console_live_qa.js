...
function main() {
  ...
  check('freshness', 'single-build-timestamp',
    has(files.version, "BUILD_TIMESTAMP = '20260518_0455'") &&
      has(files.sw, "20260518_0455") &&
      has(files.index, 't=20260518_0455') &&
      has(files.pc, 't=20260518_0455'),
  ...
  check('blueprint', 'blueprint-documents-sprint113',
    has(files.blueprint, 'Phase 113 Repair Console Live QA') &&
      ...
      has(files.blueprint, '20260518_0455'),
