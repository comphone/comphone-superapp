...
var CONFIG = {
  APP_NAME: 'COMPHONE SUPER APP v5.13.0-phase36',
  VERSION: '5.13.0-phase36',
  ...
  OPTIONAL_PROPERTIES: [
    ...
    'TELEGRAM_CHAT_TECHNICIAN',
    'TELEGRAM_CHAT_ACCOUNTING',
    'TELEGRAM_CHAT_PROCUREMENT',
    'TELEGRAM_CHAT_SALES',
...
function setScriptPropertiesFromPayload(payload) {
  ...
  var allowed = [
    ...
    'TELEGRAM_CHAT_TECHNICIAN', 'TELEGRAM_CHAT_ACCOUNTING', 'TELEGRAM_CHAT_PROCUREMENT',
    'TELEGRAM_CHAT_SALES', 'TELEGRAM_CHAT_EXECUTIVE',
